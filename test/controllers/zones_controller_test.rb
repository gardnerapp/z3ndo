...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference("Zone.count") do
      post zones_url, params: { zone: { name: @zone.name, purpose: @zone.purpose, rules: @zone.rules } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { name: @zone.name, purpose: @zone.purpose, rules: @zone.rules } }
